...
const HomeIconButton = props => {
  ...
  //Check if the button is active and set the styling acccordingly
  let activeClass;
  if (isActive) {
  ...
  return (
    <button className={`${styles.IconButton} ${activeClass}`} onClick={onClick}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="3rem" height="3rem">
        <g>
