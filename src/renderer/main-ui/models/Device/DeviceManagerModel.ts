...
// Models
import { DeviceModelProxy } from './DeviceModelProxy';
...
export class DeviceManagerModel {
   ...
   */
  @observable protected readonly isRecording: boolean;
   ...
   */
  public async getAvailableDeviceModules() {
    return await this.reader.getAllDeviceNames();
  }
