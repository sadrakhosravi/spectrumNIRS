...
const Gain = () => {
  return (
    <div className="bg-grey3 h-1/3 relative mt-5 rounded-md duration-300 border-[1.5px] border-[transparent] hover:drop-shadow-xl hover:border-[1.5px] hover:border-accent">
      <Header title="Gain" />
